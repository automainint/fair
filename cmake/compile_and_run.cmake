...
execute_and_check(clang${CMAKE_EXECUTABLE_SUFFIX} ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}.c -o ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}${CMAKE_EXECUTABLE_SUFFIX})
