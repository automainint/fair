...
execute_and_check(${CMAKE_C_COMPILER} ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}.c -o ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}${CMAKE_EXECUTABLE_SUFFIX})
