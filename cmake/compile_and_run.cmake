...
execute_and_check(llc${CMAKE_EXECUTABLE_SUFFIX} --filetype=obj ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}.ll -o ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}.o)
execute_and_check(clang${CMAKE_EXECUTABLE_SUFFIX} ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}.o -o ${CMAKE_CURRENT_BINARY_DIR}/${TEST_FOLDER}/${TEST_NAME}${CMAKE_EXECUTABLE_SUFFIX})
